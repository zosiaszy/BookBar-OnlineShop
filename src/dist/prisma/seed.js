    ...
    return [
        {
            ...
            author: 'James Clear',
            description: 'Czym są nawyki i jaka jest ich siła? Czy wyzbywając się złych i wzmacniając te dobre, jesteśmy w stanie być szczęśliwsi? Zobacz, jak do kwestii przyzwyczajeń podszedł James Clear w książce pod tytułem „Atomowe nawyki. Drobne zmiany, niezwykłe efekty.',
            rating: 4.7,
            price: 10,
        ...
        },
        {
            ...
            description: 'Dwudziestoletnia Violet Sorrengail miała trafić do Kwadrantu Skrybów i wieść spokojne życie pośród książek i historii. A teraz głównodowodząca, znana również jako jej bezkompromisowa matka, nakazała Violet dołączyć do setek kandydatów pragnących zostać elitą Navarry – jeźdźców smoków.',
            rating: 4.6,
            price: 12,
        ...
        },
        {
            ...
            author: 'Delia Owens',
            description: 'Pogłoski o Dziewczynie z Bagien latami krążyły po Barkley Cove, sennym miasteczku u wybrzeży Karoliny Północnej. Dlatego pod koniec 1969 roku, gdy na  mokradłach znaleziono ciało przystojnego Chase’a Andrewsa, miejscowi zwrócili się przeciwko Kyi Clark, zwanej Dziewczyną z Bagien.',
            rating: 4.8,
            price: 16,
            image: 'raki.jpg',
        },
        ...
        },
        {
            ...
            description: 'Nazista uciekający przed sprawiedliwością. Kobieta próbująca przywrócić honor swojej rodzinie. Tajemniczy włamywacze szukający śladów przeszłości. Co ich łączy? Schronisko.',
            rating: 4.4,
            price: 13,
        ...
        },
        {
            ...
            title: 'Uwięziona',
            author: 'B.A Paris',
            description: 'Przekłady na 40 języków. Ponad 3,5 miliona sprzedanych egzemplarzy „Za zamkniętymi drzwiami”. Jest ciemno. Nie wiesz, gdzie jesteś. Słyszysz zbliżające się kroki. A potem… krzyki swojego męża.',
            rating: 4.6,
            price: 14,
            image: 'uwieziona.jpg',
        },
